...
Hard-coded paths and parameters:
    in_pattern   = /ceph/dwong/trigger_samples/v2_300k_rand/traces_energy_{energy}.zst
...
# -------------------
def main() -> int:
    in_pattern = "/ceph/dwong/trigger_samples/v2_300k_80ev_rand/traces_energy_{energy}.zst"
    ...
    out_dir = Path("/ceph/dwong/trigger_samples/v2_300k_80ev_rand/indiv_max_amp")
