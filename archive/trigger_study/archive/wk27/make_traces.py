...
from archive.trigger_study.archive.wk27.trace_IO import *  # if you actually need things from here
...
BASE_OUTDIR = Path("/ceph/dwong/work/center")  # base folder
...
# Config
# -------------------
TOTAL_SETS       = 100        # events per energy
TRACE_SAMPLES    = 50_000
DTYPE            = np.float16
COMPRESSION_LEVEL = 15

ENERGIES         = list(range(0, 101, 2))  # 0,2,...,58 (30 energies)
