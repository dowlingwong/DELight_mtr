...
from wk23.training_samples.trace_IO import *
...
# Config
# -------------------
N_SETS = 400                    # traces per energy
TRACE_SAMPLES = 300_000         # must match long_trace_samples passed to lts.generate
DTYPE = np.float16
COMPRESSION_LEVEL = 15
ENERGIES = list(range(50, 81, 2))  # [5,10,15,20,25,30]
MAX_THREADS = 20
OUTDIR = Path(f"/ceph/dwong/trigger_samples/400sample_v2_300k")
