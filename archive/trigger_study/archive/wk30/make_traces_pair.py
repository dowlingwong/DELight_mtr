...
OUTDIR = Path("/ceph/dwong/trigger_samples/sanity_check_Jan12/center")
...
# Fixed event position for all generated traces
FIXED_X = 0.0
FIXED_Y = 0.0
FIXED_Z = -1700.0
...
def generate_and_save_batch(batch_idx: int, batch_size: int, outdir: Path):
    ...
    x0, y0, z0 = pos if pos != (None, None, None) else (FIXED_X, FIXED_Y, FIXED_Z)
    meta_dset[0] = (
    ...
    for i in range(1, batch_size):
        ...
        x, y, z = pos_i if pos_i != (None, None, None) else (FIXED_X, FIXED_Y, FIXED_Z)
        meta_dset[i] = (
