...
class Plotter:
    ...
    def __init__(self, config={}):
        ...
        self.show_watermark = config.get('show_watermark', True)
        self.watermark_kwargs = config.get('watermark_kwargs', {})
    ...
    def plot(self, xdata, ydata=None, **kwargs):
    ...
    def hist(self, data, **kwargs):
        plt.style.use('./style/delight_hist.mplstyle')
    ...
    def pretty(self):
        ...
        if self.show_watermark:
            watermark(ax=self.ax, information=self.infotext, **self.watermark_kwargs)
